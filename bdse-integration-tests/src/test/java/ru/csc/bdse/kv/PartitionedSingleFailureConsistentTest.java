...
public class PartitionedSingleFailureConsistentTest extends AbstractPartitionedKeyValueApiHttpClientTest {
    ...
    public PartitionedSingleFailureConsistentTest() {
    ...
    protected KeyValueApi newCluster1() {
        ...
        Partitioner partitioner = new ConsistentHashMd5Partitioner(partitions);
